---
id: S14-M-congelamento-m
titulo: Correção de bugs e ensaio da apresentação
trilha: T1
responsavel: micael
revisor: fernando
semana: S14
requisitos: []
secoes_doc: []
branch: fix/S14-M-congelamento-m
tipo: [correcao-de-bug]
status: backlog
---
# Correção de bugs e ensaio da apresentação

> **Micael** · semana **S14** (25/11 a 01/12) · marco da semana: _Entrega em 01/12_
