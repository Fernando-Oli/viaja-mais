...
| 2.2 | 7º | 02 | 02/09/2026 | Catálogo de requisitos funcionais do domínio Viagem e Itinerário: gestão de viagens (RF03), itinerário (RF05), reservas (RF07) e lugares e mapas (RF08), com status e prioridades revisados conforme as evidências existentes no repositório. |
2.3   | 7º | 02 | 02/09/2026 |Catálogo de requisitos do domínio Financeiro e modelo do rateio: detalhamento dos requisitos existentes de controle financeiro (RF06.1 a RF06.7) e inclusão dos requisitos de rateio de despesas, contemplando identificação de quem realizou o pagamento, tipos de rateio (igualitário, ponderado e por valor exato), cálculo das parcelas individuais, saldo por membro, quitação e minimização de transferências. Definida a regra de arredondamento para garantir a soma exata dos valores rateados e especificado o controle de acesso por RLS para os dados financeiros compartilhados.
| 2.4 | 7º | 02 | 09/09/2026 | Correção dos cinco defeitos P0 herdados do scaffolding, no domínio de Viagem e Itinerário: texto solto renderizado na tela inicial; consulta de itinerário sem junção interna (`!inner`), que exibia itens de viagens de outros usuários; criador não registrado como membro da própria viagem, o que a tornava invisível na lista; convite aceito que não atualizava a lista sem recarregar a página; e tela de redefinição de senha que ignorava o token do link de recuperação. Cada correção acompanhada de teste de regressão automatizado. |
